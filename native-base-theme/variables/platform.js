...
export default {
  ...
  // Button
  btnFontFamily: "ubuntu-light", // platform === "ios" ? "System" : "Roboto_medium",
  ...
  // Font
  fontFamily: "ubuntu-light", //platform === "ios" ? "System" : "Roboto",
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: "ubuntu-light", //platform === "ios" ? "System" : "Roboto_medium",
